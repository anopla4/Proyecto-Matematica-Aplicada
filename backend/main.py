...
data_transf = data_performing(data, ['Provincia', 'Municipio',
       'Situación académica', 'Fuente de Ingreso', 'Organización política', 'Sexo',
       'Color de la piel', 'Edad'], [1,1,1,1,1,1,1,1], {"Municipio": 'municipality_raw_parser'})
